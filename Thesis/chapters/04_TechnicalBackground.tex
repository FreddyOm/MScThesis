...
\subsubsection*{Hierarchical Z-Buffering} \label{subsec-hierarchical-z-buffering}
...
\subsubsection*{Two-Pass Occlusion Culling} \label{subsec-two-pass-occlusion-culling}
...
\subsubsection*{Depth Reprojection} \label{subsec-depth-reprojection}
