...
\begin{figure}[h!]              % Lucy 256 Voxels Test Anim (@TODO: add all other models as well)
    \begin{center}
      \begin{tikzpicture}
        \begin{axis}[
  ...
  \begin{figure}[h!]            % Lucy 256 OT Nodes Test Anim (@TODO: Add other models as well)
    \begin{center}
      \begin{tikzpicture}
        \begin{axis}[
            width=\linewidth, % Scale the plot to \linewidth
