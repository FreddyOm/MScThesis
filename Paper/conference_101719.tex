...
\begin{abstract}
    ...
    the mesh shading pipeline in combination with a parse voxel octree (SVO) can adapt the HZB to 
    efficiently occlude a significant number of voxels, which results in an overall performance 
    increase.
\end{abstract}
