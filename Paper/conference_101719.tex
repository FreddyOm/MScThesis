...
% Test different configurations varying the threadgroup size, chunk sizes and so on.
% Test the scaling of the algorithm when faced with higher resolution scenes.
