...
and \emph{Stanford Bunny}, Patrick Min for \emph{binvox} and Ketra Games for \emph{Terrain}.
...
\bibitem{b18} NVIDIA, ``NVIDIA ADA GPU ARCHITECTURE'', nvidia.com, https://images.nvidia.com/aem-dam/Solutions/geforce/ada/nvidia-ada-gpu-architecture.pdf, 2023 (accessed Feb. 19, 2025)
\bibitem{b17} C. Kubisch, ``Introduction to Turing Mesh Shaders,'' nvidia.com, https://developer.nvidia.com/blog/introduction-turing-mesh-shaders/, 2018, (accessed Feb. 19, 2025)
...
\bibitem{b12} B. Karis, R. Stubbe, and G. Wihlidal, ``A Deep Dive into Nanite Virtualized Geometry,'' realtimerendering.com, in ACM SIGGRAPH 2021 Courses, Advances in Real-Time Rendering in Games, Part 1, https://advances.realtimerendering.com/s2021/index.html (accessed Feb. 17, 2025)
\bibitem{b13} Remedy Entertainment, ``How Northlight makes Alan Wake 2 shine,'' remedygames.com, https://www.remedygames.com/article/how-northlight-makes-alan-wake-2-shine (accessed Feb. 17, 2025)
...
\bibitem{b7} Stanford Computer Graphics Laboratory, ``The Stanford 3D Scanning Repository,'' stanford.edu, https://graphics.stanford.edu/data/3Dscanrep/, 2023 (accessed Feb. 17, 2025)
\bibitem{b15} Ketra Games, ``Creating Terrain from Heightmaps - Unity Game Development Tutorial,'' kreta-games.com, https://www.ketra-games.com/2021/08/creating-terrain-from-heightmaps-unity-game-tutorial.html, 2021 (accessed Feb. 17, 2025)
...
\bibitem{b16} Sketchfab, ``Hairball,'' sketchfab.com,  https://sketchfab.com/3d-models/hairball-db894e830ad94216ae6188396d707aff, 2011 (accessed Feb. 17, 2025)
\end{thebibliography}
\vspace{12pt}
\end{document}
