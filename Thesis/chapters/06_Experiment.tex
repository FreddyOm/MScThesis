...
\begin{figure}[h!]              % Lucy renderTimes
  \begin{center}
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{Overview of the render times over the course of the test animation. The graph shows the time each frame took to 
    execute the function \emph{Render()} on the \ac{CPU}. This includes the completion of the \ac{GPU} computations.}
    \label{plt:lucy-256-culling-render-time}
  \end{center}
\end{figure}


\begin{figure}[h!]              % Lucy updateTimes
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
          width=\linewidth,
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{Overview of the frames over the course of the test animation. The graph shows the time it took to execute the 
    \emph{Update()} function on the \ac{CPU}.}
    \label{plt:lucy-256-culling-update-time}
  \end{center}
\end{figure}
...
more reliable results. Figure \ref{plt:lucy-256-culling-render-time} shows the isolated computation time of the 
...
\noindent
Figure \ref{plt:lucy-256-culling-update-time} shows the time the update function took to calculate the new camera 
...
\begin{figure}[h]              % Bunny renderTimes
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
          width=\linewidth,
    ...
    \caption{Overview of the render times over the course of the test animation. The graph shows the time each frame took to 
    execute the function \emph{Render()} on the \ac{CPU}. This includes the completion of the \ac{GPU} computations.}
    \label{plt:bunny-256-culling-render-time}
  \end{center}
\end{figure}


\begin{figure}[h]              % Bunny updateTimes
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
          width=\linewidth,
    ...
    \caption{Overview of the frames over the course of the test animation. The graph shows the time it took to execute the 
    \emph{Update()} function on the \ac{CPU}.}
    \label{plt:bunny-256-culling-update-time}
  \end{center}
\end{figure}
...
why there would be any difference here. Similarly, figure \ref{plt:bunny-256-culling-update-time} also shows 
