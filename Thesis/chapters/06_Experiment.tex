...
\begin{figure}[h]              % Lucy frameTimes
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
          width=\linewidth,
        ...
        \addplot[green, no marks, solid] table[col sep=comma, x=frame, y=time]{./plotdata/cpu/lucy_256_frameTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, y=time]{./plotdata/cpu/lucy_256_frameTime.csv};
      \end{axis}
    \end{tikzpicture}
    \caption{}
    \label{plt:lucy-256-culling-frame-time}
  \end{center}
\end{figure}
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[green, no marks, solid] table[col sep=comma, x=frame, y=time]{./plotdata/cpu/lucy_256_renderTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, y=time]{./plotdata/cpu/lucy_256_renderTime.csv};
      \end{axis}
    \end{tikzpicture}
    \caption{}
    \label{plt:lucy-256-culling-frame-time}
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[green, no marks, solid] table[col sep=comma, x=frame, y=time]{./plotdata/cpu/lucy_256_updateTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, y=time]{./plotdata/cpu/lucy_256_updateTime.csv};
      \end{axis}
    \end{tikzpicture}
    \caption{}
    \label{plt:lucy-256-culling-frame-time}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      bar width=10pt,
      xlabel={Time ($\mu$s)},
      symbolic y coords={LucyPM4, Lucy4, LucyPM2, Lucy3, LucyPM1, Lucy2, LucyPM3, Lucy0, LucyPM0, Lucy1},
      yticklabels={Per-Octree Node OC, Per-Meshlet OC, Per-Octree Node OC,Per-Meshlet OC, Per-Octree Node OC, Per-Meshlet OC, Per-Octree Node OC, Per-Meshlet OC, Per-Octree Node OC, Per-Meshlet OC},
      ytick=data,
