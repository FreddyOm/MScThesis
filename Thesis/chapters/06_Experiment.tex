  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[green, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 2392 / 1863, y=time]{./plotdata/cpu/lucy_256_updateTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 2392 / 1867, y=time]{./plotdata/cpu/lucy_256_updateTime.csv};
      \end{axis}
    \end{tikzpicture}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[green, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 2392 / 1863, y=time]{./plotdata/cpu/lucy_256_renderTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 2392 / 1867, y=time]{./plotdata/cpu/lucy_256_renderTime.csv};
      \end{axis}
    \end{tikzpicture}
...
\begin{figure}[!htb]      % Lucy GPU Results
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      ytick=data,
      xlabel={Time ($\mu$s)},
      symbolic y coords={LucyOOC, LucyMOC},
      yticklabels={B, A},
      ytick=data,
      legend style={at={(0.5,1.05)}, anchor=south, legend columns=-1}
    ]

    \addplot [fill=green!80]  table [col sep=comma, x=DepthPrepass, y=Label]  {plotdata/gpu/lucy_gpu_profiling_frame.csv};
    \addplot [fill=blue!60]   table [col sep=comma, x=DispatchMesh, y=Label]  {plotdata/gpu/lucy_gpu_profiling_frame.csv};
    \addplot [fill=orange!60] table [col sep=comma, x=Misc,         y=Label]  {plotdata/gpu/lucy_gpu_profiling_frame.csv};
  ...
  \begin{tikzpicture}
    ...
    \addplot [fill=red!80]    table [col sep=comma, x=DispatchBestOccluders,  y=Label]  {plotdata/gpu/lucy_gpu_profiling_prepass.csv};
    \addplot [fill=pink!60]   table [col sep=comma, x=CopyTex,                y=Label]  {plotdata/gpu/lucy_gpu_profiling_prepass.csv};
    \addplot [fill=yellow!60] table [col sep=comma, x=GenMipChain,            y=Label]  {plotdata/gpu/lucy_gpu_profiling_prepass.csv};
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[green, no marks, solid]  table[col sep=comma, x=frame, x expr=\thisrow{frame} * 1186 / 1574, y=time]{./plotdata/cpu/bunny_256_updateTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 1186 / 1700, y=time]{./plotdata/cpu/bunny_256_updateTime.csv};
      \end{axis}
    \end{tikzpicture}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[green, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 1186 / 1574, y=time]{./plotdata/cpu/bunny_256_renderTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 1186 / 1700, y=time]{./plotdata/cpu/bunny_256_renderTime.csv};
      \end{axis}
    \end{tikzpicture}
    \caption{Overview of the render times over the course of the test animation. The first graph shows the time 
    each frame took to execute the \emph{Update()} function on the \ac{CPU}. The second graph shows the time each 
...
\begin{figure}[!htb]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      bar width=8pt,
      xlabel={Time ($\mu$s)},
      symbolic y coords={BunnyOOC, BunnyMOC},
      yticklabels={B, A},
      ytick=data,
      legend style={at={(0.5,1.05)}, anchor=south, legend columns=-1}
    ]

    \addplot [fill=green!80]  table [col sep=comma, x=DepthPrepass, y=Label]  {plotdata/gpu/bunny_gpu_profiling_frame.csv};
    \addplot [fill=blue!60]   table [col sep=comma, x=DispatchMesh, y=Label]  {plotdata/gpu/bunny_gpu_profiling_frame.csv};
    \addplot [fill=orange!60] table [col sep=comma, x=Misc,         y=Label]  {plotdata/gpu/bunny_gpu_profiling_frame.csv};
  ...
  \begin{tikzpicture}
    ...
    \addplot [fill=red!80]    table [col sep=comma, x=DispatchBestOccluders,  y=Label]  {plotdata/gpu/bunny_gpu_profiling_prepass.csv};
    \addplot [fill=pink!60]   table [col sep=comma, x=CopyTex,                y=Label]  {plotdata/gpu/bunny_gpu_profiling_prepass.csv};
    \addplot [fill=yellow!60] table [col sep=comma, x=GenMipChain,            y=Label]  {plotdata/gpu/bunny_gpu_profiling_prepass.csv};
...
\begin{figure}[!htb]              % Torus 256 Voxels Test Anim
    \begin{center}
      ...
      \caption{First: The amount of visible voxels over the course of the test animation shown in green for 
      per-octree occlusion culling, and in orange for per-meshlet occlusion culling. The average amount of 
      visible voxels was \emph{359,313} for per-octree occlusion culling, which is marked as the blue dotted 
      line, and \emph{170,772} for per-meshlet occlusion culling, marked in red. Second: The amount of visible 
      octree nodes over the course of the test animation shown in green for per-octree occlusion culling and 
      in orange for per-meshlet occlusion culling. The average amount of visible octree nodes was \emph{7,712} 
      for per-octree occlusion culling, which is marked as the blue dotted line, and \emph{4,768} for per-meshlet 
      occlusion culling, which is marked in as the red dotted line.}
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[green, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 1554 / 1863, y=time]{./plotdata/cpu/torus_256_updateTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 1087 / 1785, y=time]{./plotdata/cpu/torus_256_updateTime.csv};
      \end{axis}
    \end{tikzpicture}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[green, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 1087 / 1554, y=time]{./plotdata/cpu/torus_256_renderTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 1087 / 1785, y=time]{./plotdata/cpu/torus_256_renderTime.csv};
      \end{axis}
    \end{tikzpicture}
...
\begin{figure}[!htb]              % Torus GPU times
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      bar width=8pt,
      xlabel={Time ($\mu$s)},
      symbolic y coords={TorusOOC, TorusMOC},
      yticklabels={B, A},
      ytick=data,
      legend style={at={(0.5,1.05)}, anchor=south, legend columns=-1}
    ]

    \addplot [fill=green!80]  table [col sep=comma, x=DepthPrepass, y=Label]  {plotdata/gpu/torus_gpu_profiling_frame.csv};
    \addplot [fill=blue!60]   table [col sep=comma, x=DispatchMesh, y=Label]  {plotdata/gpu/torus_gpu_profiling_frame.csv};
    \addplot [fill=orange!60] table [col sep=comma, x=Misc,         y=Label]  {plotdata/gpu/torus_gpu_profiling_frame.csv};
  ...
  \begin{tikzpicture}
    ...
    \addplot [fill=red!80]    table [col sep=comma, x=DispatchBestOccluders,  y=Label]  {plotdata/gpu/torus_gpu_profiling_prepass.csv};
    \addplot [fill=pink!60]   table [col sep=comma, x=CopyTex,                y=Label]  {plotdata/gpu/torus_gpu_profiling_prepass.csv};
    \addplot [fill=yellow!60] table [col sep=comma, x=GenMipChain,            y=Label]  {plotdata/gpu/torus_gpu_profiling_prepass.csv};
...
\begin{figure}[!htb]              % Terrain 256 Voxels Test Anim
    \begin{center}
      ...
      occlusion culling, and in orange for per-meshlet occlusion culling. The average amount of visible voxels 
      was \emph{396,228} for per-octree occlusion culling, which is marked as the blue dotted line, and 
      \emph{180,440} for per-meshlet occlusion culling, marked in red. Second: The amount of visible octree 
      nodes over the course of the test animation shown in green for per-octree occlusion culling and in orange 
      for per-meshlet occlusion culling. The average amount of visible octree nodes was \emph{8,207} for 
      per-octree occlusion culling, which is marked as the blue dotted line, and \emph{3,832} for per-meshlet 
      occlusion culling, which is marked in as the red dotted line. }
...
\noindent
The terrain model showed a rather stable occlusion over time, with a ratio of about $58.4\%$ culled voxels 
using the per-octree culling configuration, and about $81.1\%$ voxels being culled on average in the per-meshlet 
configuration. It was essential that the model in question has a minimal volume 
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[green, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 1239 / 1572, y=time]{./plotdata/cpu/terrain_256_updateTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 1239 / 1813, y=time]{./plotdata/cpu/terrain_256_updateTime.csv};
      \end{axis}
    \end{tikzpicture}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[green, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 1239 / 1572, y=time]{./plotdata/cpu/terrain_256_renderTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 1239 / 1813, y=time]{./plotdata/cpu/terrain_256_renderTime.csv};
      \end{axis}
    \end{tikzpicture}
    \caption{Overview of the render times over the course of the test animation. The upper graph shows the time 
    each frame took to execute the \emph{Update()} function on the \ac{CPU}. The lower graph shows the time each 
...
\begin{figure}[!htb]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      bar width=8pt,
      xlabel={Time ($\mu$s)},
      symbolic y coords={TerrainOOC, TerrainMOC},
      yticklabels={B, A},
      ytick=data,
      legend style={at={(0.5,1.05)}, anchor=south, legend columns=-1}
    ]

    \addplot [fill=green!80]  table [col sep=comma, x=DepthPrepass, y=Label]  {plotdata/gpu/terrain_gpu_profiling_frame.csv};
    \addplot [fill=blue!60]   table [col sep=comma, x=DispatchMesh, y=Label]  {plotdata/gpu/terrain_gpu_profiling_frame.csv};
    \addplot [fill=orange!60] table [col sep=comma, x=Misc,         y=Label]  {plotdata/gpu/terrain_gpu_profiling_frame.csv};
  ...
  \begin{tikzpicture}
    ...
    \addplot [fill=red!80]    table [col sep=comma, x=DispatchBestOccluders,  y=Label]  {plotdata/gpu/terrain_gpu_profiling_prepass.csv};
    \addplot [fill=pink!60]   table [col sep=comma, x=CopyTex,                y=Label]  {plotdata/gpu/terrain_gpu_profiling_prepass.csv};
    \addplot [fill=yellow!60] table [col sep=comma, x=GenMipChain,            y=Label]  {plotdata/gpu/terrain_gpu_profiling_prepass.csv};
...
\begin{figure}[!htb]              % Hairball 256 Voxels Test Anim
  ...
  \begin{figure}[!htb]            % Hairball 256 OT Nodes Test Anim
    \begin{center}
      \begin{tikzpicture}
        \begin{axis}[
            width=\linewidth, % Scale the plot to \linewidth
...
\subsubsection*{CPU Performance Results} \label{subsubsec-cpu-performance-results-hariball}
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[green, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 940 / 1421, y=time]{./plotdata/cpu/hairball_256_updateTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 940 / 1446, y=time]{./plotdata/cpu/hairball_256_updateTime.csv};
      \end{axis}
    \end{tikzpicture}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[green, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 940 / 1421, y=time]{./plotdata/cpu/hairball_256_renderTime_pooc.csv};
        \addplot[orange, no marks, solid] table[col sep=comma, x=frame, x expr=\thisrow{frame} * 940 / 1446, y=time]{./plotdata/cpu/hairball_256_renderTime.csv};
      \end{axis}
    \end{tikzpicture}
    \caption{Overview of the render times over the course of the test animation. The upper graph shows the time 
    each frame took to execute the \emph{Update()} function on the \ac{CPU}. The lower graph shows the time each 
...
\subsubsection*{GPU Performance Results} \label{subsubsec-gpu-performance-results-hariball}
