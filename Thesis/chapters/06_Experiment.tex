...
\noindent
The measurement show that each scene was processed in significantly less than 16.6 ms. The 
computation times clearly scale with the amount of voxels.
...
model. This result is as expected, since most of the work was executed on the \ac{GPU}, including the creation of the 
...
no voxels in other parts. Also, the \emph{Torus} is an inherently round shape and therefore has a lot 
of partially filled octree nodes representing its surface. 
