...
discuss the overall results the measurments provided. Tables \ref{tbl:culling-result-overview-pooc} 
...
more the octree nodes were filled on average. A high average fill indicates the existance of a lot of best occluders 
...
differences that could reliably traced back to the tested approaches. Small differences were usually in the 
...
achieve better results in terms of overdraw, although it was highly dependant on camera angle and dense 
