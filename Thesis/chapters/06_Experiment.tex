...
\begin{figure}[h]
  \centering
  \includegraphics[width=100px]{images/graphics/model-lucy.jpg}
  \includegraphics[width=100px]{images/graphics/model-bunny.jpg}
  \includegraphics[width=100px]{images/graphics/model-torus.jpg}
  \includegraphics[width=100px]{images/graphics/model-terrain.jpg}
...
\noindent
The \emph{Torus} provides a higher voxel count and a hole in it, which will create an area where the 
octree isn't densly filled with voxels. This model is specifically used to test the algorithms 
capabilities of culling voxels, when the voxels are densly crowded in small parts of the scene, and 
also provides areas with no voxels at all. Also, the \emph{Torus} is an inherently round shape and 
therefore will have a lot of partially filled octree nodes representing its surface. \\

\noindent
The \emph{Terrain} model aims to replicate a relatively flat, open area that could be found in actual 
games like \emph{Minecraft}. It is  
