...
\begin{figure}    % GPU time overview
  \begin{center}
    \begin{tikzpicture}
      ...
      \addplot+[bar shift=-15pt] coordinates {(Lucy,314.9) (Bunny,802.91) (Torus,664.36) (Terrain,707.65) (Hairball,1224)};
      \addplot+[bar shift=15pt] coordinates {(Lucy,220.2036) (Bunny,512.8592) (Torus,419.6544) (Terrain,410.5716) (Hairball,1042)};
      \legend{Per-Octree Occlsion Culling, Per-Meshlet Occlusion Culling}
      \end{axis}
    \end{tikzpicture}
  \end{center}
