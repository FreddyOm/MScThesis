...
The octree implementation allows for a boundary and a maximum instances per node threshold to be defined. 
...
\begin{figure}[h]
    ...
    of the whole voxel model. The best occluders describe the non-visible core of the model and can be 
    aggregated and used to occlude many non-visible voxels during rendering.}
