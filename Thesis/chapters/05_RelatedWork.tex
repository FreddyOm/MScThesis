...
\noindent
Over the years, many other games have made use of voxel rendering, adapting these principles of data compression and 
data streaming. Most optimizations rely on culling voxels which are not visible, i.e. faces that touch other faces.
...
generated directly on the GPU. Various efforts have been made to optimize voxel representations for ray traced 
pipelines. [@TODO: sources]
