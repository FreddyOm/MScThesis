    ...
    \begin{center}
      \begin{tikzpicture}
        \begin{axis}[
          ...
          \addplot[red, no marks, solid] table[col sep=comma, x=frame, y=visible_voxels]{./plotdata/torus_256_voxels.csv};
          \addplot[blue, dotted, no marks, domain=0:2393, samples=50] {140842};
        \end{axis}
      \end{tikzpicture}
      \caption{The amount of visible voxels over the course of the test animation shown in red. 
    ...
    \begin{center}
      \begin{tikzpicture}
        \begin{axis}[
          ...
          \addplot[red, no marks, solid] table[col sep=comma, x=frame, y=visible_nodes]{./plotdata/torus_256_nodes.csv};
          \addplot[blue, dotted, no marks, domain=0:2393, samples=50] {3460};
        \end{axis}
      \end{tikzpicture}
      \caption{The amount of visible octree nodes over the course of the test animation shown in red. 
