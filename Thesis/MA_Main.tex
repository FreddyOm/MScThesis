...
\begin{document} 
    ...
    \input{chapters/03_Motivation.tex}
    \input{chapters/04_TechnicalBackground.tex}
    \input{chapters/05_RelatedWork.tex}
    \input{chapters/06_Methodology.tex}
    \input{chapters/07_CaseStudy.tex}
    \input{chapters/08_Results.tex}
    \input{chapters/09_Discussion.tex}
    \input{chapters/10_Prospect.tex}
