...
computation times scaled with the amount of voxels within the scene.
...
while the number of total voxels in the scene was 331,254 voxels. The average amount of visible 
octree nodes was 3,460 for \ac{PONOC} and 2,483 for \ac{PMOC}. The number of total octree nodes 
in the scene was 6,830. \\
...
\noindent [@TODO: Add average divergence to all models]
...
while the number of total voxels in the scene was 3,379,738 voxels. The average amount of
visible octree nodes was 8,519 for \ac{PONOC} and 5,415 for \ac{PMOC}. The number of total 
octree nodes in the scene was 57,481. \\
...
when the torus was viewed from an angle, from which th hole in the middle was occluded. The variation between 
